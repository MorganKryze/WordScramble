...
namespace Word_Scramble
{
    ...
    public class Game
    {
        ...
        public void SelectWords(Player player)
        {
            ...
            Pause();
            chrono.Start();
            while(wordsLeft.Count is not 0 && chrono.ElapsedMilliseconds < CurrentBoard.Timer) 
            {
                ...
                while(anchor2.X is -1 && wordsLeft.Count is not 0 && chrono.ElapsedMilliseconds < CurrentBoard.Timer)
                {
